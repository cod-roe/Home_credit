...
def evaluate_ensemble(input_df, col_pred):
    print(f'[auc] model1:{roc_auc_score(input_df["true"], input_df["pred1"]):.4f}, model2:{roc_auc_score(input_df["true"], input_df["pred2"]):.4f}, model3:{roc_auc_score(input_df["true"], input_df["pred3"]):.4f} -> ensemble:{roc_auc_score(input_df["true"], input_df[col_pred]):.4f}')
